...
<div class="container pd-0">
	<div class="timeline mb-30">
		<ul>
			<c:forEach items="${cour.seances }" var="seance">
				<li>
					...
					<div class="timeline-desc card-box">
						<div class="pd-20">
							...
							<c:if test="${seance.etat == true }">
								<div class="d-flex">
									<c:if test="${seances.contains(seance) == false }">
										<form action="${initParam.APP_PATH }etudiant/participerseance.do" method="POST">
											<input type="hidden" value="${seance.id }" name="idSeance">
											<button onclick="return confirm('Vous-etes sur??')" type="submit" class="btn btn-primary btn-sm">
