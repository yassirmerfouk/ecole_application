			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="${initParam.APP_PATH }etudiant/profile.do">
							<i class="dw dw-user1"></i>
							Profile
						</a>
						<a class="dropdown-item" href="${initParam.APP_PATH }tuteur/index.do">
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li>
						<a href="${initParam.APP_PATH }etudiant/index.do" class="dropdown-toggle no-arrow">
					...
					<li>
						<a href="${initParam.APP_PATH }etudiant/cours.do" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span>
							</span>
					...
					<li>
						<a href="${initParam.APP_PATH }etudiant/mescours.do" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span>
							</span>
							<span class="mtext">Mes cours</span>
						</a>
					</li>
					<li>
						<a href="${initParam.APP_PATH }etudiant/messeances.do" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span>
							</span>
							<span class="mtext">Mes seances</span>
						</a>
					</li>
				</ul>
			</div>
