			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name">${not empty admin ? admin.username : 'Guest' }</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="${initParam.APP_PATH }admin/profile.do">
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li>
						<a href="${initParam.APP_PATH }admin/index.do" class="dropdown-toggle no-arrow">
					...
					<li>
						<a href="${initParam.APP_PATH }admin/departements.do" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span>
							</span>
							<span class="mtext">Departements</span>
						</a>
					</li>
					<li>
						<a href="${initParam.APP_PATH }admin/matieres.do" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span>
							</span>
							<span class="mtext">Matieres</span>
						</a>
					</li>
					<li>
						<a href="${initParam.APP_PATH }admin/etudiants.do" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span>
							</span>
